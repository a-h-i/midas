...
struct TraderContext {
  ...
  boost::signals2::scoped_connection historicalBarConn, historicalEndCon, realtimeBarCon;
  std::shared_ptr<midas::Subscription> historicalSubscription, realtimeSubscription;
  TraderContext(std::atomic<bool> *, unsigned int numSecondsHistory, TradingContext *, midas::InstrumentEnum);
};