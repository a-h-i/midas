...
virtual void accountUpdateMulti([[maybe_unused]] int reqId,
                                [[maybe_unused]] const std::string &account,
                                [[maybe_unused]] const std::string &modelCode,
...
virtual void
newsProviders([[maybe_unused]] const std::vector<NewsProvider> &newsProviders) {
  ERROR_LOG(logger) << "Unsupported feature";
}
 ...
 */
virtual void headTimestamp([[maybe_unused]] int reqId,
...
virtual void rerouteMktDepthReq([[maybe_unused]] int reqId,
                                [[maybe_unused]] int conid,
                                [[maybe_unused]] const std::string &exchange) {
  ERROR_LOG(logger) << "Unsupported feature";
}
 ...
 */
virtual void
historicalTicks(int reqId, const std::vector<HistoricalTick> &ticks, bool done);
...
virtual void
historicalTicksBidAsk(int reqId, const std::vector<HistoricalTickBidAsk> &ticks,
                      bool done);
